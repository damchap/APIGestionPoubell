INSERT INTO `facture` (`idFacture`, `moisF`, `anF`, `nomFacture`, `idHabitation`) VALUES
(7, 7, 2015, 'hab1-usag1-Facture-juillet-2015.pdf', 'hab1'),
...
INSERT INTO `habitation` (`idHabitation`, `adrRueHab`, `cpHab`, `adrVilleHab`, `nbPersonne`, `idUsager`) VALUES
...
INSERT INTO `levee` (`idLevee`, `laDate`, `poids`, `idPoubelle`) VALUES
(1, '2015-07-15', 5, 'pb1'),
(4, '2015-07-17', 15, 'pb2'),
...
INSERT INTO `poubelle` (`idPoubelle`, `idTypeDechet`, `idHabitation`) VALUES
('pb1', 'V', 'hab1'),
('pb2', 'R', 'hab1'),
('pb3', 'R', 'hab2'),
('pb4', 'V', 'hab2'),
...
INSERT INTO `tarif` (`typeTarif`, `valeur`, `libelle`) VALUES
(1, 3, 'prix par personne logement ind'),
(2, 2, 'prix par personne logement col');

INSERT INTO `typedechet` (`idTypeDechet`, `libelle`, `tarif`) VALUES
('C', 'déchets classiques', 0.1556),
('R', 'déchets recyclables', 0.251),
('V', 'verre recyclable', 0.1156);

INSERT INTO `usager` (`idUsager`, `nom`, `prenom`, `adrRueUsager`, `cpUsager`, `adrVilleUsager`, `login`, `mdp`) VALUES
